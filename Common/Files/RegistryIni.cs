 ...
 * 
 * This is free software, distributed under the thermsandconditions of the FreeBSD License. For the full License text
...
namespace Multipetros.Config
{
    ...
    {
        /// <summary>
        /// An enum constant representing the current user option.
        /// </summary>
        CurrentUser,
        /// <summary>
        /// An enum constant representing the local machine option.
        /// </summary>
        LocalMachine
    }
    ...
    public class RegistryIni
    {
        ...
        /// <summary>
        /// Constructor with company and product name to configure. The properties stored under the HKEY_CURRENT_USER\Software\companyName\productName\ node
        /// </summary>
        ...
        /// <summary>
        /// Constructor with product name and registry node to configure. The properties can be stored under the: <ul>
        ...
        /// <summary>
        /// Constructor with company name, product name and registry node to configure. The properties can be stored under the: <ul>
        ...
        /// <summary>
        /// Access properties like Dictionary, negotiating with the property sub keyandvalue name eg: registryIniObj["subKeyName","valueName"]
        /// When getting value of the specified property, or empty string if property not found
        ...
        /// <summary>
        /// Access properties like Dictionary, negotiating with the property subkeys pathandvalue name eg: registryIniObj[["subKeyA","subKeyB",..],"valueName"]
        /// When getting value of the specified property, or empty string if property not found
        ...
        /// <summary>
        /// Object deconstructor. Closing the basic application regisry keyandflushes any unsaved changes.
        /// </summary>
        ~RegistryIni()
        {
            baseAppKey.Close();
